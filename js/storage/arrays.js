...
export const featuredArray = [
  ...
  // },
  {
    ...
    text: "Course assignment of JS Frameworks. Built with React and React Bootstrap. Back-end use a headless CMS plugin in WordPress. User can login and receive a jwt in localstorage, so that user is kept logged-in when revisiting website.",
    image: "../../images/strategy-games.jpg",
    url: "https://sprightly-wisp-dc5788.netlify.app/",
    github: "https://github.com/lassopicasso/js-frameworks-ca.git",
    javascript: "React",
    css: "Bootstrap",
  },
  // {
